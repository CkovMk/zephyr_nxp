...
#define VIDEO_PIX_FMT_RGB32 video_fourcc('A', 'R', '2', '4') /* 32  BGRA-8-8-8-8 */

/* YUV formats */
#define VIDEO_PIX_FMT_YUYV video_fourcc('Y', 'U', 'Y', 'V') /* 16  YUV 4:2:2 */
#define VIDEO_PIX_FMT_UYVY video_fourcc('U', 'Y', 'V', 'Y') /* 16  YUV 4:2:2 */
