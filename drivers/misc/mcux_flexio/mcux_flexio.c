...
#include <i2c/i2c_mcux_flexio.h>
/* add new interface */

#include <zephyr/logging/log.h>
LOG_MODULE_REGISTER(flexio_mcux_flexio, CONFIG_LOG_DEFAULT_LEVEL);
...
enum mcux_flexio_type {
	NXP_IMX_FLEXIO_I2C_MASTER = 0,
	NXP_IMX_FLEXIO_SPI = 1,
	/* add new interface */
	NXP_IMX_FLEXIO_LAST_INDEX,
};

static const struct mcux_flexio_child_config children_config[NXP_IMX_FLEXIO_LAST_INDEX] = {
	[NXP_IMX_FLEXIO_I2C_MASTER] = { i2c_mcux_flexio_isr, i2c_mcux_flexio_res },
